...
.SYNOPSIS
    Creates a Bootable FAT32 USB (32GB or smaller) and copies a Mounted ISO. (Modified to run as an SCCM package via a Task Sequence)
.DESCRIPTION
...
[System.String]$LogFile = "X:\windows\temp\isotousb_LogFile.log"
[System.String]$ISOFile = "$scriptpath\BootMediax64.iso"
[System.String]$USBLabel = "SCCMBoot"
    ...
    if ($SelectedDisk) {
        ...
        Start-Process -FilePath "x:\windows\system32\bootsect.exe" -ArgumentList "/nt60", "$($DriveLetter):" -NoNewWindow -Wait
		#=================================================
